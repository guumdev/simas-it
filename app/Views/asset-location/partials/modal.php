<!-- Modal -->
<div class="modal fade bs-example-modal-lg" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true" id="alocation-modal">
  <div class=" modal-dialog modal-lg">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form class="needs-validation" id="alocation-form" novalidate>
          <?= csrf_field(); ?>
          <input type="hidden" id="form-alocation-id" name="id">
          <div class="col-lg-12 mb-3">
            <label class="form-label" for="form-code">Kode <span class="text-danger">*</span></label>
            <input class="form-control" type="text" id="form-code" name="code" placeholder="Masukkan kode lokasi aset"></input>
          </div>
          <div class="col-lg-12 mb-3">
            <label class="form-label" for="form-name">Nama <span class="text-danger">*</span></label>
            <input class="form-control" type="text" id="form-name" name="name" placeholder="Masukkan nama lokasi aset"></input>
          </div>
          <div class="col-lg-12">
